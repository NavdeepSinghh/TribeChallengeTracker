...
- App Store products exist for `com.risewiththetribe.pro.monthly`, `com.risewiththetribe.pro.yearly`, `com.risewiththetribe.pack.21_day_reset`, and `com.risewiththetribe.pack.summer_shred`.
...
6. Repeat purchase/restore evidence for `com.risewiththetribe.pack.21_day_reset` and `com.risewiththetribe.pack.summer_shred`.
