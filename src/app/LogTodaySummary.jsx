...
export default function LogTodaySummary({ loggedActivities, onDeleteActivity }) {
  ...
  return (
    <div style={{ marginBottom: 20, padding: "12px 14px", borderRadius: 12, background: "rgba(52,211,153,0.05)", border: "1px solid rgba(52,211,153,0.15)" }}>
      ...
      {loggedActivities.map((a, i) => {
        ...
        return (
          <div key={a.id || i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "5px 0", borderTop: i === 0 ? "none" : `1px solid ${theme.divider}` }}>
