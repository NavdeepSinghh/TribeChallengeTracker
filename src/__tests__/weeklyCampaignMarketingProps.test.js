...
describe("Weekly Campaign marketing props", () => {
  it("maps the derived model into the Weekly Campaign marketing prop contract", () => {
    ...
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyQaCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply QA Kit");
    ...
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveCompletionHandoffCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Handoff Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveCompletionQaCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion QA Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveCompletionReviewHandoffCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Review Handoff Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveCompletionReviewQaCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Review QA Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveFinalClosureHandoffCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure Handoff Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveFinalClosureQaCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure QA Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveFinalClosureReceiptHandoffCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure Receipt Handoff Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveFinalClosureReceiptQaCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure Receipt QA Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveHandoffCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Handoff Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveQaCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive QA Kit");
    ...
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplySentReceiptHandoffCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Sent Receipt Handoff Kit");
    expect(props.launchRetrospectiveNextCampaignReviewDecisionReplySentReceiptQaCopy).toContain("Launch Retrospective Next Campaign Review Decision Reply Sent Receipt QA Kit");
  ...
  it("builds an operator summary from first-party campaign signals", () => {
    ...
    expect(sectionData.weeklyCampaignMetricKitSections).toHaveLength(74);
    ...
    expect(sectionData.weeklyCampaignMetricKitSections[57].title).toBe("Launch Retrospective Next Campaign Review Decision Reply QA Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[57].buttonLabel).toBe("COPY REVIEW REPLY QA");
    expect(sectionData.weeklyCampaignMetricKitSections[57].copyText).toContain("Manual next campaign review decision reply QA");
    expect(sectionData.weeklyCampaignMetricKitSections[57].copyText).toContain("decision reply QA reviewer");
    expect(sectionData.weeklyCampaignMetricKitSections[58].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Operator Handoff Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[58].buttonLabel).toBe("COPY REPLY OPERATOR");
    expect(sectionData.weeklyCampaignMetricKitSections[58].copyText).toContain("Manual next campaign review decision reply operator handoff");
    expect(sectionData.weeklyCampaignMetricKitSections[58].copyText).toContain("decision reply operator");
    expect(sectionData.weeklyCampaignMetricKitSections[59].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Operator QA Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[59].buttonLabel).toBe("COPY REPLY OPERATOR QA");
    expect(sectionData.weeklyCampaignMetricKitSections[59].copyText).toContain("Manual next campaign review decision reply operator QA");
    expect(sectionData.weeklyCampaignMetricKitSections[59].copyText).toContain("decision reply operator QA reviewer");
    expect(sectionData.weeklyCampaignMetricKitSections[60].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Send Readiness Kit");
    ...
    expect(sectionData.weeklyCampaignMetricKitSections[62].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Sent Receipt Handoff Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[62].buttonLabel).toBe("COPY REPLY RECEIPT");
    expect(sectionData.weeklyCampaignMetricKitSections[62].copyText).toContain("Manual next campaign review decision reply sent receipt handoff");
    expect(sectionData.weeklyCampaignMetricKitSections[62].copyText).toContain("sent receipt owner");
    expect(sectionData.weeklyCampaignMetricKitSections[63].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Sent Receipt QA Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[63].buttonLabel).toBe("COPY RECEIPT QA");
    expect(sectionData.weeklyCampaignMetricKitSections[63].copyText).toContain("Manual next campaign review decision reply sent receipt QA");
    expect(sectionData.weeklyCampaignMetricKitSections[63].copyText).toContain("sent receipt QA reviewer");
    expect(sectionData.weeklyCampaignMetricKitSections[64].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Handoff Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[64].buttonLabel).toBe("COPY RECEIPT ARCHIVE");
    expect(sectionData.weeklyCampaignMetricKitSections[64].copyText).toContain("Manual next campaign review decision reply receipt archive handoff");
    expect(sectionData.weeklyCampaignMetricKitSections[64].copyText).toContain("receipt archive owner");
    expect(sectionData.weeklyCampaignMetricKitSections[65].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive QA Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[65].buttonLabel).toBe("COPY ARCHIVE QA");
    expect(sectionData.weeklyCampaignMetricKitSections[65].copyText).toContain("Manual next campaign review decision reply receipt archive QA");
    expect(sectionData.weeklyCampaignMetricKitSections[65].copyText).toContain("receipt archive QA reviewer");
    expect(sectionData.weeklyCampaignMetricKitSections[66].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Handoff Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[66].buttonLabel).toBe("COPY ARCHIVE COMPLETE");
    expect(sectionData.weeklyCampaignMetricKitSections[66].copyText).toContain("Manual next campaign review decision reply receipt archive completion handoff");
    expect(sectionData.weeklyCampaignMetricKitSections[66].copyText).toContain("archive completion owner");
    expect(sectionData.weeklyCampaignMetricKitSections[67].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion QA Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[67].buttonLabel).toBe("COPY COMPLETE QA");
    expect(sectionData.weeklyCampaignMetricKitSections[67].copyText).toContain("Manual next campaign review decision reply receipt archive completion QA");
    expect(sectionData.weeklyCampaignMetricKitSections[67].copyText).toContain("archive completion QA reviewer");
    expect(sectionData.weeklyCampaignMetricKitSections[68].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Review Handoff Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[68].buttonLabel).toBe("COPY REVIEW HANDOFF");
    expect(sectionData.weeklyCampaignMetricKitSections[68].copyText).toContain("Manual next campaign review decision reply receipt archive completion review handoff");
    expect(sectionData.weeklyCampaignMetricKitSections[68].copyText).toContain("completion review owner");
    expect(sectionData.weeklyCampaignMetricKitSections[69].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Review QA Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[69].buttonLabel).toBe("COPY REVIEW QA");
    expect(sectionData.weeklyCampaignMetricKitSections[69].copyText).toContain("Manual next campaign review decision reply receipt archive completion review QA");
    expect(sectionData.weeklyCampaignMetricKitSections[69].copyText).toContain("completion review QA reviewer");
    expect(sectionData.weeklyCampaignMetricKitSections[70].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure Handoff Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[70].buttonLabel).toBe("COPY CLOSURE HANDOFF");
    expect(sectionData.weeklyCampaignMetricKitSections[70].copyText).toContain("Manual next campaign review decision reply receipt archive final closure handoff");
    expect(sectionData.weeklyCampaignMetricKitSections[70].copyText).toContain("final closure owner");
    expect(sectionData.weeklyCampaignMetricKitSections[71].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure QA Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[71].buttonLabel).toBe("COPY CLOSURE QA");
    expect(sectionData.weeklyCampaignMetricKitSections[71].copyText).toContain("Manual next campaign review decision reply receipt archive final closure QA");
    expect(sectionData.weeklyCampaignMetricKitSections[71].copyText).toContain("final closure QA reviewer");
    expect(sectionData.weeklyCampaignMetricKitSections[72].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure Receipt Handoff Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[72].buttonLabel).toBe("COPY CLOSURE RECEIPT");
    expect(sectionData.weeklyCampaignMetricKitSections[72].copyText).toContain("Manual next campaign review decision reply receipt archive final closure receipt handoff");
    expect(sectionData.weeklyCampaignMetricKitSections[72].copyText).toContain("final closure receipt owner");
    expect(sectionData.weeklyCampaignMetricKitSections[73].title).toBe("Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure Receipt QA Kit");
    expect(sectionData.weeklyCampaignMetricKitSections[73].buttonLabel).toBe("COPY RECEIPT QA");
    expect(sectionData.weeklyCampaignMetricKitSections[73].copyText).toContain("Manual next campaign review decision reply receipt archive final closure receipt QA");
    expect(sectionData.weeklyCampaignMetricKitSections[73].copyText).toContain("final closure receipt QA reviewer");
  });
});
