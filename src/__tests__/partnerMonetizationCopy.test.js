...
describe('partner monetization copy contracts', () => {
  it('builds partner campaign, contract, perk fulfillment, and decision copy without tracking or fulfillment side effects', () => {
    ...
    expect(copy.partnerSupportReadinessScriptCopy).toContain('Partner Support Readiness Script Kit');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('Manual partner support readiness script');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('sponsor campaigns and partner perks are not live');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('partner terms');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('privacy review');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('destination safety');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('refund boundaries');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('entitlement QA');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('Capture only first-party support context');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('This partner support readiness script is copy-only');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('Do not claim partner campaigns are live');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('provide live perk fulfillment');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('create partner links');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('create coupons');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('process refunds');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('write entitlements');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('share third-party data');
    expect(copy.partnerSupportReadinessScriptCopy).toContain('auto-message users');
