...
export function buildWeeklyCampaignMetricKitSections({
  ...
  return [
    ...
    {
      title: 'Launch Retrospective Next Campaign Review Handoff QA Bridge Kit',
      subtitle: 'Manual QA before review handoff',
      status: 'REVIEW QA',
      accent: '#16A34A',
      ...
      body: 'Check the approved review handoff bridge, callback evidence, first-party signal summary, support route, consent queue, paid-language hold, and review owners before review handoff starts.',
      buttonLabel: 'COPY REVIEW QA BRIDGE',
      copyText: launchRetrospectiveNextCampaignReviewHandoffQaBridgeCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Owner Handoff Kit',
      subtitle: 'Manual handoff into campaign review',
      status: 'REVIEW OWNER',
      accent: '#22C55E',
      background: 'rgba(34,197,94,0.05)',
      border: '1px solid rgba(34,197,94,0.16)',
      ...
      body: 'Hand off the approved review QA bridge, callback evidence, first-party signal summary, support route, consent queue, review notes owner, and review decision owner before campaign review starts.',
      buttonLabel: 'COPY REVIEW OWNER',
      copyText: launchRetrospectiveNextCampaignReviewOwnerHandoffCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Owner QA Kit',
      subtitle: 'Manual QA before campaign review',
      status: 'OWNER QA',
      accent: '#4ADE80',
      background: 'rgba(74,222,128,0.05)',
      border: '1px solid rgba(74,222,128,0.16)',
    ...
    {
      title: 'Launch Retrospective Next Campaign Review Notes QA Kit',
      subtitle: 'Manual QA before review decision',
      status: 'NOTES QA',
      accent: '#BBF7D0',
      background: 'rgba(187,247,208,0.05)',
      border: '1px solid rgba(187,247,208,0.16)',
      ...
      body: 'Check approved review notes, consent-safe proof, support route, consent queue, review notes owner, review decision owner, and paid-language hold before review decision copy starts.',
      buttonLabel: 'COPY REVIEW NOTES QA',
      copyText: launchRetrospectiveNextCampaignReviewNotesQaCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Decision Handoff Kit',
      subtitle: 'Manual handoff into review decision',
      status: 'DECISION',
      accent: '#DCFCE7',
    ...
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Handoff Kit',
      subtitle: 'Manual handoff into review decision replies',
      status: 'REPLY',
      accent: '#0369A1',
      ...
      body: 'Hand off approved review decision QA into the decision reply owner, reply lane, support route, consent queue, and paid-language hold before Weekly Campaign Review Decision Reply Kit copy is used.',
      buttonLabel: 'COPY REVIEW REPLY',
      copyText: launchRetrospectiveNextCampaignReviewDecisionReplyHandoffCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply QA Kit',
      subtitle: 'Manual QA before review decision replies',
      status: 'REPLY QA',
      accent: '#0E7490',
    ...
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Operator QA Kit',
      subtitle: 'Manual QA before reply operator action',
      status: 'OPERATOR QA',
      accent: '#047857',
      ...
      body: 'Check the reply operator handoff, approved reply-copy source, reply lane, support route, consent queue, and paid-language hold before any human reply operator acts.',
      buttonLabel: 'COPY REPLY OPERATOR QA',
      copyText: launchRetrospectiveNextCampaignReviewDecisionReplyOperatorQaCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Send Readiness Kit',
      subtitle: 'Manual readiness before reply send',
      status: 'SEND READY',
      accent: '#15803D',
      background: 'rgba(21,128,61,0.05)',
      border: '1px solid rgba(21,128,61,0.16)',
    ...
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Sent Receipt Handoff Kit',
      subtitle: 'Manual handoff after reply send',
      status: 'RECEIPT',
      accent: '#2563EB',
    ...
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Handoff Kit',
      subtitle: 'Manual handoff before receipt archive',
      status: 'ARCHIVE',
      accent: '#7C3AED',
      ...
      body: 'Hand off the approved sent receipt QA into archive ownership with manual send timestamp, support route, consent queue, paid-language hold, and no-paid-live note.',
      buttonLabel: 'COPY RECEIPT ARCHIVE',
      copyText: launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveHandoffCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Receipt Archive QA Kit',
      subtitle: 'Manual QA before receipt archive',
      status: 'ARCHIVE QA',
      accent: '#9333EA',
      ...
      body: 'QA the receipt archive handoff, approved receipt reference, manual send timestamp, support route, consent queue, paid-language hold, and no-paid-live note before archive completion.',
      buttonLabel: 'COPY ARCHIVE QA',
      copyText: launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveQaCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Handoff Kit',
      subtitle: 'Manual handoff before archive completion',
      status: 'COMPLETE',
      accent: '#4F46E5',
    ...
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Review Handoff Kit',
      subtitle: 'Manual handoff to completion review',
      status: 'REVIEW HANDOFF',
      accent: '#3730A3',
      ...
      body: 'Hand off the accepted archive completion QA note, approved references, support route, consent queue, paid-language hold, and no-paid-live note before final retrospective closure.',
      buttonLabel: 'COPY REVIEW HANDOFF',
      copyText: launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveCompletionReviewHandoffCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Completion Review QA Kit',
      subtitle: 'Manual QA before final closure',
      status: 'REVIEW QA',
      accent: '#312E81',
      background: 'rgba(49,46,129,0.05)',
      border: '1px solid rgba(49,46,129,0.16)',
      ...
      body: 'QA the completion review handoff, approved archive completion QA reference, support route, consent queue, paid-language hold, and no-paid-live note before final retrospective closure is accepted.',
      buttonLabel: 'COPY REVIEW QA',
      copyText: launchRetrospectiveNextCampaignReviewDecisionReplyReceiptArchiveCompletionReviewQaCopy,
    },
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure Handoff Kit',
      subtitle: 'Manual handoff to final closure',
    ...
    {
      title: 'Launch Retrospective Next Campaign Review Decision Reply Receipt Archive Final Closure Receipt Handoff Kit',
      subtitle: 'Manual handoff to closure receipt',
      status: 'CLOSURE RECEIPT',
      accent: '#0F172A',
