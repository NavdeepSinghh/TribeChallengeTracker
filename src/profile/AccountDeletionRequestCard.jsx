export default function AccountDeletionRequestCard({
  ...
  const palette = theme || {
    ...
    cardBorder: 'rgba(248,113,113,0.16)',
    mutedStrong: '#888',
    text: '#fff',
    textSoft: '#aaa',
    textInverse: '#111',
  ...
  return (
    <>
      <p style={{ color: palette.mutedStrong, fontSize: 10, fontWeight: 700, letterSpacing: 2, fontFamily: 'monospace', margin: '0 0 12px' }}>ACCOUNT DELETION REQUEST</p>
      <div style={{
        background: palette.cardBg, border: `1px solid ${palette.cardBorder}`,
        borderRadius: 16, padding: 14, marginBottom: 20,
      }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'flex-start', marginBottom: 8 }}>
          <p style={{ margin: 0, color: palette.text, fontSize: 14, fontWeight: 900, fontFamily: "'Syne', sans-serif" }}>
          ...
          <span style={{
            ...
            background: accountDeletionRequested ? 'rgba(52,211,153,0.12)' : palette.cardBg,
            color: accountDeletionRequested ? '#34D399' : palette.textSoft,
            fontSize: 8, fontWeight: 900, fontFamily: 'monospace', letterSpacing: 1,
          }}>
            {accountDeletionRequested ? 'REQUESTED' : 'NOT REQUESTED'}
          </span>
        </div>
        <p style={{ margin: '0 0 12px', color: palette.textSoft, fontSize: 10, lineHeight: 1.5, fontWeight: 800 }}>
        ...
        <button
          ...
          style={{
            ...
            color: accountDeletionRequested ? palette.mutedStrong : palette.textInverse,
