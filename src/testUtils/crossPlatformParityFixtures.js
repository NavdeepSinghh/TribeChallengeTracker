...
const iosCreatorChallengeTemplateDraftSection = fs.readFileSync(path.resolve(repoRoot, '../TribeChallengeTrackerIOS/TribeChallenge/Views/CreatorChallengeTemplateDraftSection.swift'), 'utf8');
const iosCreatorChallengeTemplateDraftReviewRow = fs.readFileSync(path.resolve(repoRoot, '../TribeChallengeTrackerIOS/TribeChallenge/Views/CreatorChallengeTemplateDraftReviewRow.swift'), 'utf8');
const iosPublishedCreatorChallengeTemplateCatalogSection = fs.readFileSync(path.resolve(repoRoot, '../TribeChallengeTrackerIOS/TribeChallenge/Views/PublishedCreatorChallengeTemplateCatalogSection.swift'), 'utf8');
...
const androidCreatorChallengeTemplateDraftSection = fs.readFileSync(path.resolve(repoRoot, '../TribeChallengeTrackerAndroid/app/src/main/java/com/risewiththetribe/challengetracker/ui/CreatorChallengeTemplateDraftSection.kt'), 'utf8');
const androidCreatorChallengeTemplateDraftReviewRow = fs.readFileSync(path.resolve(repoRoot, '../TribeChallengeTrackerAndroid/app/src/main/java/com/risewiththetribe/challengetracker/ui/CreatorChallengeTemplateDraftReviewRow.kt'), 'utf8');
const androidPublishedCreatorChallengeTemplateCatalogSection = fs.readFileSync(path.resolve(repoRoot, '../TribeChallengeTrackerAndroid/app/src/main/java/com/risewiththetribe/challengetracker/ui/PublishedCreatorChallengeTemplateCatalogSection.kt'), 'utf8');
