const ROADMAP_TOKENS = [
  ...
  "Web admin/creator copy-ready member-safe readiness script done for requested pack",
  "Creator Payout Support Readiness Script Kit",
  "Web profile copy-only creator-safe readiness script done for payout support follow-up",
  "Partner Support Readiness Script Kit",
  "Web admin copy-only member-safe support readiness script done for partner support follow-up",
...
const FEATURE_CATALOG_TOKENS = [
  ...
  "Challenge Pack Store Readiness Script Kit",
  "Web admin/creator profile surfaces show a Challenge Pack Store Readiness Script Kit",
  "Web profile surfaces show a Creator Payout Support Readiness Script Kit",
  "Web admin profiles include a Partner Support Readiness Script Kit",
