...
function verifyReleaseScriptContracts(packageJson) {
  ...
  assert(packageJson.scripts?.["test:pro-trial-support"] === "react-scripts test --runTestsByPath src/__tests__/proTrialSupportEscalationCopy.test.js --watchAll=false --runInBand", "package.json must define test:pro-trial-support");
