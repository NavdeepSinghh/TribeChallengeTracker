...
- Weekly Campaign derived data now has focused coverage for core planning copy, experiment recommendation, story/engagement copy, collab cards, retention follow-up, support triage, re-invite copy, first-party signal wording, and no-automation/no-tracking boundaries.
- Weekly Campaign marketing props now have focused adapter coverage for creator/admin flags, Instagram calendar copy, launch-card copy, collab cards, Support Triage Kit copy, Support Readiness Script Kit copy, comment replies, and the complete prop key contract.
